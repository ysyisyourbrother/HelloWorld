...
class SymphonySystemBenchV6(SymphonySystemBenchV5):
    """v6 Benchmark 编排：MemoryAgentV6 的 agentic 检索作答管线（VLM 内嵌，无需本地大模型）。"""

    def _benchmark_uses_api_vlm(self) -> bool:
        return bool(self.use_cloud)
